...
function [params,fullParams] = getSimParams(exampleFolder)        
    ...
    %"params"
        ...
        subFolder0 = ["0.1_simulation_configurations.csv", ...
                      "0.2_numerical_methods.csv", ...
                      "0.3_simulation_outputs.csv", ...
                      "1.1_natural_constants.csv", ...
                      "1.2_adsorbate_properties.csv", ...
                      "1.3_adsorbent_properties.csv", ...
                      "2.1_feed_stream_properties.csv", ...
                      "2.2_raffinate_stream_properties.csv", ...
                      "2.3_extract_stream_properties.csv", ...
                      "3.1_adsorber_properties.csv", ...
                      "3.2_feed_tank_properties.csv", ...
                      "3.3_raffinate_tank_properties.csv", ...
                      "3.4_extract_tank_properties.csv", ...
                      "3.5_feed_compressor_properties.csv", ...
                      "3.6_extract_compressor_properties.csv", ...
                      "3.7_vacuum_pump_properties.csv", ...
                      "4.1_cycle_organization.csv"];
        %-----------------------------------------------------------------%
